...
import numpy as np
import torch
from.networks import SwinTransformer_Backbone
from PIL import Image
from .config_su import get_config_or
from .utils import tensor2img, load_networks
from .data.aug import MultiResolutionImage
...
class SwinTrans_G(nn.Module):
    ...
    def __init__(self, pretrained_ckpt:Optional[Path]=None, gpu_id:int=0):
        ...
        self.inference_aug = MultiResolutionImage(org_size=(112, 224))        
